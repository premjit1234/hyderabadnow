...
export default function AdminListingEditForm({
  ...
  return (
    <form action={formAction} className="flex flex-col gap-4">
      ...
      <div className="rounded-md border border-stone-200 p-4">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-stone-500">
              Bare Shell / Warm Shell apply to Commercial listings (shown there as &quot;Fit-out Status&quot;).
            </p>
          </div>
          <div>
      ...
      <div className="rounded-md border border-stone-200 p-4">
        <p className="mb-3 text-sm font-semibold text-stone-900">Property-type-specific details</p>
        <p className="mb-3 text-xs text-stone-500">
          Only the fields relevant to this listing&rsquo;s Property Type above need filling in. Saving clears any of
          these that don&rsquo;t apply to the selected Property Type.
        </p>
